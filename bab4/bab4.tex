...
\begin{enumerate}
    ...
    \item \textbf{Zona Mitigasi Dinamis} --- kondisi ketika usia nasabah saat pengajuan masih di bawah 80 tahun, tetapi tenor yang diminta menyebabkan usia pelunasan melewati 80 tahun. Pada zona ini, sistem memberikan status \texttt{Grade Undefined} dan menghitung rekomendasi tenor maksimal secara dinamis menggunakan Persamaan \ref{eq:bab4_max_tenor}.
