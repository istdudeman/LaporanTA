...
Pemantauan \textit{drift} diimplementasikan menggunakan dua metrik stabilitas yang saling melengkapi dalam modul drift\_monitor.py:
...
Apabila nilai PSI atau salah satu CSI fitur melampaui ambang batas \textbf{0.25}, sistem secara otomatis memicu \textit{endpoint} \textit{webhook} n8n (/webhook/retrain-trigger) untuk memulai proses pelatihan ulang model menggunakan data terbaru.
