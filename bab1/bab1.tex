...
\begin{enumerate}
    ...
    \item Belum tersedia arsitektur pipeline MLOps berbasis low-code yang mengintegrasikan validasi data sintetis, pelacakan eksperimen, deployment API, interpretabilitas model, aturan bisnis, deteksi drift, dan retraining otomatis untuk sistem analisis risiko kredit.
\end{enumerate}
\section{Tujuan}
...
\begin{enumerate}
    ...
    \item Mengembangkan pipeline otomatis yang mencakup pembentukan dan validasi data sintetis, pra-pemrosesan WoE-IV, penanganan ketidakseimbangan kelas, pelatihan XGBoost, pelacakan eksperimen, deployment API, monitoring drift, dan retraining otomatis.
...
\begin{enumerate}
    ...
    \item Fokus penelitian adalah pada perancangan pipeline MLOps, evaluasi performa model, validasi kualitas data sintetis, deployment layanan inferensi, penerapan aturan bisnis, serta monitoring drift dan retraining otomatis.
\end{enumerate}
