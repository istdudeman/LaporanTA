...
\tikzset{
  brstep/.style={rectangle, draw, rounded corners, text centered, align=center, fill=blue!10, minimum height=2em},
  brdecision/.style={diamond, draw, text centered, align=center, fill=yellow!20},
  brok/.style={rectangle, draw, text centered, align=center, fill=green!20, minimum height=2em},
  brerr/.style={rectangle, draw, text centered, align=center, fill=red!20, minimum height=2em},
  brarrow/.style={thick, ->, >=stealth}
}
