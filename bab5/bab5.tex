...
\begin{enumerate}
    \item Penelitian ini berhasil merancang pipeline MLOps untuk operasionalisasi model prediktif risiko kredit, mulai dari pembentukan data sintetis, pra-pemrosesan, pelatihan model, deployment API, interpretabilitas, hingga monitoring drift dan retraining otomatis.
    ...
    \item Implementasi MLflow dan n8n menunjukkan bahwa proses pelacakan eksperimen, monitoring drift, dan pemicuan retraining dapat diotomatisasi. Dengan demikian, sistem yang dibangun dapat menjadi prototipe awal pipeline MLOps untuk model risiko kredit.
\end{enumerate}
